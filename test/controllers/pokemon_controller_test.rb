...
class PokemonControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon" do
    assert_difference("Pokemon.count") do
      post pokemon_index_url, params: { pokemon: { external_id: @pokemon.external_id, front_default_image: @pokemon.front_default_image, name: @pokemon.name } }
    end
  ...
  test "should update pokemon" do
    patch pokemon_url(@pokemon), params: { pokemon: { external_id: @pokemon.external_id, front_default_image: @pokemon.front_default_image, name: @pokemon.name } }
